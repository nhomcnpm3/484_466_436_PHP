...
<html lang="en">
  <head>
    ...
    <link href="<?php echo e(asset('css/slick-slider.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/prettyphoto.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('build/mediaelementplayer.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('style.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/color.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/color-two.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/color-three.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/color-four.css')); ?>" rel="stylesheet">
    ...
    <?php $__env->startSection('sidebar'); ?>
		...
		<header id="wm-header" class="wm-header-one">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul class="wm-adminuser-section">
                                ...
                                <li>
                                <div class="dropdown">
                                <img style="width:30px;height:30px;border-radius:50px;border:none;margin-right:5px;" src="<?php echo e(asset('extra-images')); ?>/<?php echo e(auth()->user()->AVT); ?>" alt=""><button onclick="myFunction()" class="dropbtn" style="font-size:13px"><?php echo e(auth()->user()->Email); ?></button>
                                    <div id="myDropdown" class="dropdown-content">
                                        <a style="color:black;font-size:13px"href="<?php echo e(route('profile')); ?>">Profile</a>
                                        <a style="color:black;font-size:13px"href="#about">About</a>
                                        <a style="color:black;font-size:13px"href="<?php echo e(route('logout')); ?>">Logout</a>
                                    </div>
                                    </div>
                                    </li>
                                    <?php else: ?>
            ...
            <div class="wm-main-header">
                <div class="container">
                    <div class="row">
                        <div class="col-md-3"><a href="<?php echo e(route('home')); ?>" class="wm-logo"><img src="<?php echo e(asset('images/logo-1.png')); ?>" alt=""></a></div>
                        <div class="col-md-9">
                            <!--// Navigation \\-->
                            <nav class="navbar navbar-default">
                                ...
                                <div class="collapse navbar-collapse" id="navbar-collapse-1">
                                  <ul class="nav navbar-nav">
                                    ...
                                    <li><a href="<?php echo e(route('classlist')); ?>">Class list</a>
                                    </li>
            ...
            <div class="wm-modallogin-form wm-login-popup">
                ...
                <form action="<?php echo e(route('xl-dang-nhap')); ?>" method="POST">
                    ...
                    <ul>
                        ...
                        <li> <a href="<?php echo e(route('forgotpassword')); ?>" class="wm-forgot-btn">Forgot Password?</a> </li>
                ...
                <ul class="wm-login-social-media">
                    ...
                    <li class="wm-googleplus-color"><a href="<?php echo e(url('/auth/redirect/google')); ?>"><i class="fa fa-google-plus-square"></i> Google+</a></li>
                </ul>
  ...
  if (($('#newaccpassword').val() == $('#newaccconfirm_password').val()) && ($('#newaccpassword').val().length >= 8))
   {
	...
	<script type="text/javascript" src="<?php echo e(asset('script/jquery.js')); ?>"></script>
	<script type="text/javascript" src="<?php echo e(asset('script/modernizr.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('script/bootstrap.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('script/jquery.prettyphoto.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('script/jquery.countdown.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('script/fitvideo.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('script/skills.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('script/slick.slider.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('script/waypoints-min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('build/mediaelement-and-player.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('script/isotope.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('script/jquery.nicescroll.min.js')); ?>"></script>
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js"></script>
    <script type="text/javascript" src="<?php echo e(asset('script/functions.js')); ?>"></script>

  </body>
</html>
<?php /**PATH F:\BT\Nam3\PHP\484_466_436_PHP\elearning\resources\views/layouts/master.blade.php ENDPATH**/ ?>