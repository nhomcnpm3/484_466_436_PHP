...
<?php $__env->startSection('content'); ?>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="date" class="form-control" value="<?php echo e(auth()->user()->NgaySinh); ?>" placeholder="Enter birthday" name="bd">
    ...
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
		...
		<!--// Main Content \\-->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookair/Desktop/484_466_436_PHP/elearning/resources/views/reset_profile_birthday.blade.php ENDPATH**/ ?>