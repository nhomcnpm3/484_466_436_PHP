            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="wm-plane-title">
                        ...
                        <h2>Change the full name</h2>
                    </div>
                    <div class="wm-courses wm-courses-popular wm-courses-mediumsec">
                        <form class="form-horizontal" method="POST" action="<?php echo e(route('capNhatTen')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="email">Full name:</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value="<?php echo e(auth()->user()->Ten); ?>" placeholder="Enter fullname" name="Ten">
...
<!--// Main Content \\-->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookair/Desktop/484_466_436_PHP/elearning/resources/views/profile/reset_profile_name.blade.php ENDPATH**/ ?>