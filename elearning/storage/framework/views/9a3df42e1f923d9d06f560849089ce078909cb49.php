            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="wm-courses wm-courses-popular wm-courses-mediumsec">
                        <form class="form-horizontal" action="<?php echo e(route('CreateClass')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\19PMC\PHP-nang-cao\Do an\484_466_436_PHP\elearning\resources\views/class/create_class.blade.php ENDPATH**/ ?>