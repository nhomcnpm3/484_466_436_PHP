                     ...
                     <div class="banner_taital_main">
                        <div class="row">
                           <div class="col-md-6">
                              ...
                              <div class="btn_main">
                                 <div class="about_bt active"><a href="#" data-toggle="modal" data-target="#exampleModalCenter">Login now</a></div>
                     ...
                     <div class="banner_taital_main">
                        <div class="row">
                           <div class="col-md-6">
                              ...
                              <p class="banner_text">Eiusmod tempor incididunt ut labore et dolore magna aliqua</p>
                              <div class="btn_main">
                                 <div class="about_bt active"><a href="#">Login now</a></div>
                                 <div class="quote_bt"><a href="#">Get A Quote</a></div>
                              </div>
                           </div>
                           <div class="col-md-6">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\484_466_436_PHP\elearning\resources\views/index.blade.php ENDPATH**/ ?>