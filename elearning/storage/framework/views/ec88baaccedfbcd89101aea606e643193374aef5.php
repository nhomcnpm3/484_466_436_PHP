    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <a href="<?php echo e(route('showCreateClass')); ?>" class="btn  btn-lg" style="background-color:#b99663;color:white">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $classlist->DSLop; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>    
                        <li class="col-md-12">
                            <div class="wm-courses-popular-wrap">
                                <figure> <a href="<?php echo e(route('classdetail')); ?>"><img src="<?php echo e(asset('extra-images')); ?>/<?php echo e($class->Logo); ?>" alt=""> <span class="wm-popular-hover"> <small>see class</small> </span> </a>
                                    <figcaption>
                                        <h6><a href="<?php echo e(route('classdetail')); ?>"><?php echo e($class->TaiKhoan->Ten); ?></a></h6>
                                    </figcaption>
                                </figure>
                                <div class="wm-popular-courses-text">
                                    <h6><a href="<?php echo e(route('classdetail')); ?>"><?php echo e($class->TenLop); ?></a></h6>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\19PMC\PHP-nang-cao\Do an\484_466_436_PHP\elearning\resources\views/class/classlist.blade.php ENDPATH**/ ?>