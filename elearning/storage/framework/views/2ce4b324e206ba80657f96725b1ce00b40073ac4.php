    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <a href="#" class="btn  btn-lg" style="background-color:#b99663;color:white">
                    ...
                    <ul class="row">
                        <li class="col-md-12">
                            <div class="wm-courses-popular-wrap">
                                <figure> <a href="<?php echo e(route('classdetail')); ?>"><img src="extra-images/papular-courses-1.jpg" alt=""> <span class="wm-popular-hover"> <small>see class</small> </span> </a>
                                    <figcaption>
                                        <img src="extra-images/papular-courses-thumb-1.jpg" alt="">
                                        <h6><a href="<?php echo e(route('classdetail')); ?>">Trần Thanh Tuấn</a></h6>
                                    </figcaption>
                                </figure>
                                <div class="wm-popular-courses-text">
                                    <h6><a href="<?php echo e(route('classdetail')); ?>">PHP nâng cao CDTH19PMC</a></h6>
                                    <p>Học kỳ 5</p>
                                </div>
                            </div>
                        </li>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookair/Desktop/484_466_436_PHP/elearning/resources/views/classlist.blade.php ENDPATH**/ ?>