            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="wm-courses wm-courses-popular wm-courses-mediumsec">
                        <form class="form-horizontal" method="POST" action="{{ route('capNhatTen') }}">
                            @csrf
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="email">Full name:</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value="{{ auth()->user()->Ten}}" placeholder="Enter fullname" name="Ten">
