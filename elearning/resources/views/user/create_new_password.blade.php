				...
				<div class="container">
					<div class="row">
						<div class="wm-filterable">           
                            <span>New Password for email: {{$user->Email}}</span>
                                </div>	
                                <form class="form-horizontal" action="{{route('ReSetPass',['id'=>$user->id])}}" method="post">
                                    @csrf
                                    <div class="form-group" id="checkpassword">
                                    <label class="control-label col-sm-2">New password:</label>
                                    <div class="col-sm-10">
                                        <input type="password" class="form-control" placeholder="Enter New Password" id="password" name="oldpassword">
                                    </div>
                                    </div>
