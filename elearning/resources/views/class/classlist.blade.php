                    ...
                    @forelse($classlist->DSLop as $class)    
                        <li class="col-md-12">
                            <div class="wm-courses-popular-wrap">
                                <figure> <a href="{{route('classdetail')}}"><img src="{{asset('extra-images')}}/{{$class->Logo}}" alt=""> <span class="wm-popular-hover"> <small>see class</small> </span> </a>
                                    <figcaption>
                                        <h6><a href="{{route('classdetail')}}">{{$class->TaiKhoan->Ten}}</a></h6>
                                    </figcaption>
                                </figure>
                                <div class="wm-popular-courses-text">
                                    <h6><a href="{{route('classdetail')}}">{{$class->TenLop}}</a></h6>
                                    <p>{{$class->mota}}</p>
                                </div>
                            </div>
                        </li>
