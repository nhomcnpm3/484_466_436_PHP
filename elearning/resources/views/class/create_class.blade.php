        ...
        <div class="row">
            ...
            <form class="form-horizontal" action="{{ route('capNhatMatKhau') }}" method="post">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="password" class="form-control" id="classname" placeholder="Enter new class" name="class">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="control-label col-sm-2" for="pwd">Banner:</label>
                <div class="col-sm-10">
                <input type="file" class="form-control">
                </div>
              </div>
              <div class="form-group">
                <label class="control-label col-sm-2" for="pwd">Theme:</label>
                <div class="col-sm-10">
