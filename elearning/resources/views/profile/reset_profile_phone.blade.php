            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="wm-courses wm-courses-popular wm-courses-mediumsec">
                        <form class="form-horizontal" action="{{ route('capNhatDT') }}" method="post">
                            @csrf
                            <div class="form-group">
                                <label class="control-label col-sm-2">phone:</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value="{{ auth()->user()->phone}}" placeholder="Enter number phone" name="SDT">
